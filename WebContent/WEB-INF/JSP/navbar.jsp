...
<nav id="navBar">
    <main>
        ...
        <div>
            <button id="notificationBtn"><i class="fas fa-sticky-note"></i></button><span id="nbrReminder">${ nbrReminders }</span>
            <button id="notifyBtn"><i class="fas fa-bell"></i></button><span id="nbrNotificattion" >${ nbrNotifications }</span>
